...
npx caliper launch master --caliper-workspace . --caliper-benchconfig benchmarks/masterBenchmark/zk-voting/config.yaml --caliper-networkconfig networks/masterScripts/fabric-node-couchdb.yaml 
